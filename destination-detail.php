...
<div class="relative overflow-hidden" style="min-height:320px">
  ...
  <div class="absolute inset-0" style="background:linear-gradient(to top,#0a0a0a 0%,rgba(10,10,10,.45) 55%,rgba(10,10,10,.05) 100%)"></div>
  ...
  <div class="relative z-10 max-w-6xl mx-auto px-4 lg:px-8 flex flex-col justify-end pb-10 pt-8">
    ...
    <div class="flex flex-wrap gap-5 mt-6 reveal">
      ...
      <div class="flex items-center gap-2">
        <div style="width:34px;height:34px;border-radius:50%;background:rgba(16,185,129,.15);border:1px solid rgba(16,185,129,.3);display:flex;align-items:center;justify-content:center">
          <i class="fas <?= $s[0] ?>" style="color:#10b981;font-size:.7rem"></i>
        </div>
        <div>
  ...
  <div style="display:grid;grid-template-columns:1fr 300px;gap:2.5rem;align-items:start" class="dest-grid">
    ...
    <div>
      ...
      <section class="reveal mb-12">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(240px,1fr));gap:1rem">
          ...
          <div class="glass-card p-5 reveal">
            <div style="width:42px;height:42px;border-radius:10px;background:rgba(16,185,129,.12);border:1px solid rgba(16,185,129,.2);display:flex;align-items:center;justify-content:center;margin-bottom:.85rem">
              <i class="fas <?= $h['icon'] ?>" style="color:#10b981;font-size:.9rem"></i>
            </div>
      ...
      <section class="reveal mb-12">
        ...
        <div style="display:grid;grid-template-columns:repeat(12,1fr);gap:4px;margin-bottom:.85rem">
          <?php
          $mColors = ['peak'=>['#10b981','rgba(16,185,129,.15)'],'good'=>['#fbbf24','rgba(245,158,11,.12)'],'fair'=>['#60a5fa','rgba(59,130,246,.1)'],'low'=>['rgba(255,255,255,.2)','rgba(255,255,255,.04)']];
        ...
        <div class="flex flex-wrap gap-3 mb-4">
          <?php foreach (['peak'=>['#10b981','Peak Season'],'good'=>['#fbbf24','Good'],'fair'=>['#60a5fa','Fair'],'low'=>['rgba(255,255,255,.3)','Low Season']] as $k=>$v): ?>
      ...
      <section class="reveal mb-12">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(260px,1fr));gap:1rem">
          ...
          <a href="<?= url('tour/'.e($t['slug'])) ?>" style="background:#111;border:1px solid rgba(255,255,255,.07);border-radius:16px;overflow:hidden;display:block;text-decoration:none;transition:all .3s" class="reveal tour-card">
            ...
            <div style="padding:1rem">
              <div style="font-family:'Montserrat',sans-serif;font-size:.6rem;font-weight:700;text-transform:uppercase;letter-spacing:.12em;color:#10b981;margin-bottom:.35rem"><?= e($t['tour_type']) ?></div>
              <h3 style="font-family:'Playfair Display',serif;font-size:.95rem;font-weight:700;color:#fff;margin-bottom:.35rem;line-height:1.3"><?= e($t['name']) ?></h3>
              <div style="display:flex;align-items:center;justify-content:space-between">
                <span style="font-family:'Montserrat',sans-serif;font-size:.7rem;color:rgba(255,255,255,.4)"><?= e($t['duration']) ?></span>
                <span style="font-family:'Montserrat',sans-serif;font-size:.78rem;font-weight:700;color:#10b981">From $<?= number_format((float)$t['price']) ?></span>
              </div>
            </div>
          </a>
          <?php endforeach; ?>
      ...
      <section class="reveal mb-12" id="faq">
        ...
        <div style="display:flex;flex-direction:column;gap:.6rem">
          ...
          <div style="background:#111;border:1px solid rgba(255,255,255,.07);border-radius:14px;overflow:hidden" class="reveal">
            <button onclick="toggleFaq(<?= $i ?>)" style="width:100%;display:flex;align-items:center;justify-content:space-between;padding:1rem 1.25rem;background:none;border:none;cursor:pointer;text-align:left;gap:.75rem">
              ...
              <i id="faq-icon-<?= $i ?>" class="fas fa-plus" style="color:#10b981;font-size:.7rem;flex-shrink:0;transition:transform .3s"></i>
            </button>
    ...
    <div style="position:sticky;top:84px">
      ...
      <div class="glass-card p-6 mb-4 reveal">
        <h3 style="font-family:'Playfair Display',serif;font-size:1.15rem;font-weight:700;color:#fff;margin-bottom:.35rem">Plan Your <?= e($dest['title']) ?> Trip</h3>
      ...
      <div class="glass-card p-5 mb-4 reveal">
        ...
        <div style="display:flex;align-items:flex-start;gap:.65rem;margin-bottom:.7rem">
          <i class="fas <?= $f[0] ?>" style="color:#10b981;font-size:.65rem;margin-top:.15rem;flex-shrink:0;width:14px"></i>
          <div>
...
<!-- ═══ FOOTER CTA ═══ -->
<section style="background:linear-gradient(135deg,rgba(16,185,129,.06),rgba(5,150,105,.04));border-top:1px solid rgba(16,185,129,.1);padding:5rem 1rem">
...
<style>
.tour-card:hover{border-color:rgba(16,185,129,.25) !important;transform:translateY(-4px);box-shadow:0 16px 40px rgba(0,0,0,.5)}
.tour-card:hover .tc-img{transform:scale(1.05)}
.other-dest:hover{background:rgba(255,255,255,.05)}
.other-dest:hover div:first-child div:first-child{color:#10b981}
