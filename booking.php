  ...
  <aside class="bk-sidebar">
    ...
    <div style="background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.07);border-radius:14px;padding:1rem;margin-bottom:1.25rem">
      ...
      <div class="bk-price-row total">
        ...
        <span id="sb-total" style="font-size:1.25rem;font-weight:700;color:#10b981;font-family:'Playfair Display',serif">—</span>
      </div>
      ...
      <div class="bk-panel active" id="panel-0">
        ...
        <div id="mobile-price-calc" style="background:rgba(16,185,129,.07);border:1px solid rgba(16,185,129,.15);border-radius:12px;padding:1rem;margin-bottom:1rem;display:none">
          <div style="display:flex;justify-content:space-between;align-items:center">
            ...
            <span id="calc-total" style="font-family:'Playfair Display',serif;font-size:1.2rem;font-weight:700;color:#10b981">—</span>
          </div>
